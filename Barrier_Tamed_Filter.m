classdef Barrier_Tamed_Filter < AbstractFilter
    methods
        function obj = Barrier_Tamed_Filter(params, DxArray)
            obj@AbstractFilter(params, 'Barrier-Tamed-SIR', DxArray);
        end
    end
    methods (Access = protected)
        function [Xf, Xp] = runFilter(obj)
            ...
            if isfield(p, 'snapshot_dir')
                ...
                snapshot_cfg.filter_name = 'Barrier_Tamed_SIR';
            ...
            [Xf, Xp] = sir_barrier_tamed(p.F, p.sx, p.sz, ...
                                      ...
                                      p.ness_thr,...
                                       p.barrier_params, save_step_indices, snapshot_cfg,'Arnulf');
        end
    end
end
