classdef SIR_ExpTamed_Filter < AbstractFilter
    methods
        function obj = SIR_ExpTamed_Filter(params, DxArray)
            obj@AbstractFilter(params, 'SIR_ExpTamed', DxArray);
        end
    end
     methods (Access = protected)
        ...
        function [Xf, Xp] = runFilter(obj)
            ...
            if isfield(p, 'snapshot_dir')
                ...
                snapshot_cfg.filter_name = 'SIR_ExpTamed';
            ...
            [Xf, Xp] = sir_tamed(p.F, p.sx, p.sz, ...
                          p.he, p.NTe, p.n_obs, ...
                          p.ze_sparse, p.H, p.X0, p.ness_thr, save_step_indices, snapshot_cfg, 'ExpTamed');
        end
