...
function [Xf, Xp] = sir_barrier_tamed(F,sx,sz,h,NT,n_obs,z,H,X0,ness_thr,barrier_params,save_obs_indices,snapshot_cfg,tamed_type)
...
for obs_idx=1:nt
   ...
   for inner_idx=1:n_obs
        ...
        elseif strcmpi(tamed_type, 'ExpTamed')
            ...
            error('sir_barrier_tamed:UnknownTamedType', ...
