classdef SIR_Tamed_Filter < AbstractFilter
    methods
        function obj = SIR_Tamed_Filter(params, DxArray)
            obj@AbstractFilter(params, 'SIR-Tamed', DxArray);
        end
    end
     methods (Access = protected)
        ...
        function [Xf, Xp] = runFilter(obj)
            ...
            if isfield(p, 'snapshot_dir')
                ...
                snapshot_cfg.filter_name = 'SIR-Tamed';
            ...
            [Xf, Xp] = sir_tamed(p.F, p.sx, p.sz, ...
                          p.he, p.NTe, p.n_obs, ...
                          p.ze_sparse, p.H, p.X0, p.ness_thr, save_step_indices, snapshot_cfg,'Arnulf');
        end
